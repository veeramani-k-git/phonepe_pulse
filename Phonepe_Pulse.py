...
icon = Image.open("C:\project\phonepe_pulse\phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By veeramani",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *veeramani*!
...
# Set the destination path where you want to clone the repository
### destination_path = "Project_2_PhonepePulse/Phonepe_data/data"
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Top Charts","Explore Data","About"], 
                ...
                styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px", "--hover-color": "#6F36AD"},
                        "nav-link-selected": {"background-color": "	#BF3EFF"}})
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("### :violet[Technologies included :] Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
...
if selected == "Top Charts":
    ...
    Type = st.sidebar.selectbox("**Type**", ("Transactions", "Users"),key='unique')
...
if selected == "Explore Data":
    ...
    Type = st.sidebar.selectbox("**Type**", ("Transactions", "Users"),key='unique_key2')
